...
1 этап:
- Теперь за каждую итерацию цикла выполняется вычисление сразу для 16 точек для этого значения помещаются в массив и каждая вычислительная операция выполнятся в отдельном цикле
- 
